...
func _set_room_randomly(room_to_set: Room) -> void:
	...
	while rule1 or rule2 or rule3 or rule4:
		...
		rule1 = is_campfire and room_to_set.row < 3
		rule2 = is_campfire and has_campfire_parent
		rule3 = is_shop and has_shop_parent
		rule4 = is_campfire and room_to_set.row == 12
